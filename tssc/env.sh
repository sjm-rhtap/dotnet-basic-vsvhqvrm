...
export IMAGE_URL=${IMAGE_URL-quay.io/sjmrhtap/dotnet-basic-vsvhqvrm:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/sjm-rhtap/dotnet-basic-vsvhqvrm-gitops
